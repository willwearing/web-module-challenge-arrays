...
function addFlavor(newFlavour, originalFlavors) {
  originalFlavors.unshift(newFlavour);
  console.log(originalFlavors);
}

addFlavor("Sherbert", originalFlavors);
...
function getFlavorByIndex(originalFlavors, ind) {
  console.log(originalFlavors[ind]);
}
...
function removeFlavorByName(originalFlavors, str) {
  let num = originalFlavors.indexOf(str);
  console.log(num);
  originalFlavors.splice(num, 1);
  console.log(originalFlavors);
}
...
function copy(orgArr) {
  newArr = [...originalFlavors];
  return newArr;
}

let niceNewArray = copy(originalFlavors);
console.log(niceNewArray);
...
function getAverageWordLength(arr) {
  ...
  for (let i = 0; i < arr.length; i++) {
    totalCounts += arr[i].split(" ").length;
  }
